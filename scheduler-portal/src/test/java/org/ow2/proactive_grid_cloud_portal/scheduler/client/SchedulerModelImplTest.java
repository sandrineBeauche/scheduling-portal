...
public class SchedulerModelImplTest {
    ...
    private SchedulerModelImpl scheduler;

    @Before
    public void setUp() throws Exception {
        scheduler = new SchedulerModelImpl();
    }
    ...
    public void testAppendLiveOutput_LinuxLineBreak() {
        ...
        scheduler.appendLiveOutput("42", "[Compute1@192.168.1.168;16:07:40] first line\n[Compute1@192.168.1.168;16:07:40] second line");

        String jobOutput = scheduler.getLiveOutput("42");
    ...
    public void testAppendLiveOutput_WrongFormat() {
        ...
        scheduler.appendLiveOutput("42", "first line\r\nsecond line");
